...
**Describe the resulting dataset:** - After cleaning and tidying,
dataset `jan_2020` has 12398 rows and 9 columns, dataset `july_2020` has
21013 rows and 9 columns, dataset `jan_2024` has 18799 rows and 9
columns, dataset `july_2024` has 47043 rows and 9 columns.  
